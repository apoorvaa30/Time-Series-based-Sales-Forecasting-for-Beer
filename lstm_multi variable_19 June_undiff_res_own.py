# -*- coding: utf-8 -*-
"""
Created on Tue Jun 19 18:36:25 2018
...
series = read_csv('all_lstm_res_own.csv', header=0, parse_dates=[0], index_col=0, squeeze=True, date_parser=parser)
series = series.drop(columns = ['var(t-1)'], axis = 1)
...
n_lag = 49 #how many dependants (1,2,3,12)
...
#    train_reshaped = train[:, 0:n_lag].reshape(len(train), timesteps, n_lag)
